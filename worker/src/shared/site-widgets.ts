...
//
// Duplicated from supabase/functions/_shared/site-widgets.ts — see
// site-builder.ts's header for why there's no shared module across the
// Deno/Node boundary. Apart from this header the two files are byte-identical.
//
