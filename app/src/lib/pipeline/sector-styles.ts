// Curated layout/color guidance per sectorcategorie (spec section 3.3): a
// deliberately limited set of patterns handed to the generator as a
// constraint, rather than letting it invent a design freely.
